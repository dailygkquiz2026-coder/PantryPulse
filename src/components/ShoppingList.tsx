...
import { Trash2, CheckCircle2, ShoppingBag, Search, ExternalLink, Plus } from 'lucide-react';
            ...
            {items.map((item, index) => (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className={`font-semibold text-gray-900 ${item.status === 'bought' ? 'line-through' : ''}`}>
                      {item.name}
                    </h3>
